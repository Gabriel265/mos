          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="bg-slate-800 lg:w-1/2 p-4 sm:p-6 lg:p-8 flex flex-col justify-center items-center text-white relative min-h-[300px] lg:min-h-[600px]">
              ...
              <div className="absolute top-2 right-2 sm:top-4 sm:right-4 lg:top-8 lg:right-8">
                <div className="bg-gradient-to-r from-[#c54d42] to-[#9e1b1b] hover:from-[#9e1b1b] hover:to-[#c54d42] text-white px-2 py-1 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-bold transform rotate-12 shadow-lg cursor-pointer transition-all duration-300 hover:scale-105">
                  HIRE US TODAY!
                </div>
              </div>
            ...
            <div className="lg:w-1/2 p-4 sm:p-6 lg:p-8 flex flex-col justify-center">
              ...
              <div className="mb-6 sm:mb-8">
                ...
                <div className="inline-block bg-gradient-to-r from-[#c54d42] to-[#9e1b1b] text-white px-3 sm:px-4 py-1 sm:py-2 rounded font-bold mt-2 text-sm sm:text-base">
                  Services?
                </div>
              </div>
              ...
              {/* Services List */}
              <div className="mb-6 sm:mb-8">
                <div className="bg-gradient-to-r from-[#c54d42] to-[#9e1b1b] text-white px-3 sm:px-4 py-2 rounded-t font-bold text-sm sm:text-base">
                  We Do
                </div>
